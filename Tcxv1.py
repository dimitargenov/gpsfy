...
class Tcx():
    ...
    def calculateCadenceDiffCoeficient(self):
        if self.newCadence != None and self.newCadence.isnumeric():
            return round(int(self.newCadence) / self.cadence, 2)
        else:
            return 1
